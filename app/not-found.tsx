  ...
  return (
    <div className="  flex flex-col justify-center items-center gap-6 h-[80vh] text-center">
      <div className="flex flex-col ">
        <div className="flex  items-center mx-auto gap-2 max-w-max justify-center">
          <svg
          ...
          >
            <g>
              <g>
                <path
                  d="M256.451,231.685c16.64,11.489,39.439,7.309,50.922-9.33l91.591-132.679c11.966-17.335,35.806-21.702,53.139-9.731
			...
			C443.137-15.213,373.611-2.475,338.711,48.084l-91.591,132.679C235.634,197.403,239.81,220.199,256.451,231.685z"
                />
                <path
                  d="M313.979,440.081l-132.681,91.593c-8.399,5.8-18.55,7.984-28.584,6.14c-10.036-1.838-18.757-7.478-24.555-15.876
			...
			l132.677-91.593c16.639-11.485,20.815-34.283,9.33-50.922C353.416,432.772,330.616,428.592,313.979,440.081z"
                />
                <path
                  d="M426.242,202.848c-16.174-12.129-39.119-8.851-51.251,7.321l-70.637,94.18l-94.184,70.643
			...
			l98.368-73.78c2.775-2.08,5.238-4.546,7.321-7.321l73.778-98.364C445.694,237.924,442.416,214.979,426.242,202.848z"
                />
                <path
                  d="M416.349,469.052l-8.736,113.556c-0.3,4.115,0.316,8.488,2.007,12.559c5.78,13.921,21.752,20.519,35.671,14.739
			c13.921-5.78,20.519-21.752,14.739-35.673L416.349,469.052z"
                />
                <path
                  d="M611.914,432.724c-1.155-15.027-14.276-26.272-29.305-25.115l-113.554,8.734l105.179,43.679
